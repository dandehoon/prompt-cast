...
<div class="space-y-2">
  <div class="flex items-center justify-between">
    ...
    <button
      ...
      class="p-1.5 rounded text-xs disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
      style="color: var(--pc-error);"
      title="Close All Tabs"
    >
      {#if closeAllLoading}
        <div
          class="animate-spin w-3 h-3 border-2 border-t-transparent rounded-full"
